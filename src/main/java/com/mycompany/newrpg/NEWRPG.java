...
//            CriaPersonagensAUTO(personHUMANO,personOrc, personElfo,personHUMANO2,persoElfo2,personOrc2,listaPersonagemAUTO);
     ...
     public static void batalha(ArrayList<personagem> listaPersonagemAUTO, ArrayList<personagem> listaPersonagem){
         ...
         String[] opcoes = new String[listaPersonagem.size()];
           ...
           if(terreno == 1){
                if(p1.raca == 6 && (p2.raca <6)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");
                } else if(p1.raca == p2.raca){
                    JOptionPane.showMessageDialog(null, "EMPATE");                    
                } else if(p2.raca == 6 && (p1.raca < 6)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");
                } else if(p1.raca == 5 && (p1.raca <5)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                
                } else if(p2.raca == 5 && (p1.raca <5)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                } else if(p1.raca == 4 && (p2.raca <4 || p2.raca > 4)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                } else if(p2.raca == 4 && (p1.raca <4 || p1.raca > 4)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                
                } else if(p1.raca == 3 && (p2.raca == 4 || p2.raca == 2 || p2.raca == 1)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                
                } else if(p2.raca == 3 && (p1.raca == 4 || p1.raca == 2 || p1.raca == 1)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                 
                    ...
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                     
                } else if(p1.raca == 2 && (p2.raca < 4 || p2.raca > 4)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                } else if(p2.raca == 2 && (p1.raca < 4 || p1.raca > 4)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                     
                    ...
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                     
                } else if(p1.raca == 1 && (p2.raca == 3 || p2.raca == 5 || p2.raca == 6)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                } else if(p2.raca == 1 && (p1.raca == 3 || p1.raca == 5 || p1.raca == 6)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                     
                }
            ...
            if (terreno == 2) { // Caverna
                if((p1.raca==1||p1.raca==2 || p1.raca==3 || p1.raca==4) && (p2.raca==5 || p2.raca==6)){
                    ...
                    p1.incrementarDerrota();            
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");
                } else if((p1.raca==4)&&(p2.raca==1||p2.raca ==2 || p2.raca ==5||p2.raca ==6)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");   
                } else if((p2.raca==4)&&(p1.raca==1||p1.raca ==2 || p1.raca ==5||p1.raca ==6)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                 
                    ...
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");
                } else if (p1.raca == 6 && (p2.raca >= 1 && p2.raca <= 5)) {
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");
                } else if (p2.raca == 6 && (p1.raca >= 1 && p1.raca <= 5)) {
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");
                    ...
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");
                } else if (p1.raca == 3 && (p2.raca == 4 || p2.raca == 5 || p2.raca == 6)) {
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");
                } else if (p2.raca == 3 && (p1.raca == 4 || p1.raca == 5 || p1.raca == 6)) {
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");
                } else if (p1.raca == 3 && (p2.raca == 1 || p2.raca == 2)) {
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");
                } else if (p2.raca == 3 && (p1.raca == 1 || p1.raca == 2)) {
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");
            ...
            if(terreno == 3){ //floresta
                if(p1.raca == 6 && (p2.raca < 6)){
                    ...
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");
                } else if(p1.raca == 5 && (p2.raca == 1 || p2.raca == 3 || p2.raca == 4 || p2.raca == 6)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                
                } else if(p2.raca == 5 && (p1.raca == 1 || p1.raca == 3 || p1.raca == 4 || p1.raca == 6)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                    ...
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                } else if(p1.raca == 3 && (p2.raca < 4 || p2.raca == 5)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                } else if(p2.raca == 3 && (p1.raca == 5 || p1.raca == 6)){
                    ...
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                               
                } else if(p1.raca == 2 && (p2.raca < 2 || p2.raca > 2)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                
                } else if(p2.raca == 2 && (p1.raca < 2 || p1.raca > 2)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                                                         
                } else if(p1.raca == 1 && (p2.raca == 3 || p2.raca == 6)){
                    p1.incrementarVitoria();
                    p2.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p1.getNome() + " Ganhou!");                
                    ...
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                     
                } else if(p1.raca == 1 && (p2.raca == 2 || p2.raca == 4 || p2.raca == 5)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                
                } else if(p2.raca == 1 && (p1.raca == 2 || p1.raca == 4 || p1.raca == 5)){
                    p2.incrementarVitoria();
                    p1.incrementarDerrota();
                    JOptionPane.showMessageDialog(null, "O personagem " + p2.getNome() + " Ganhou!");                     
                }
